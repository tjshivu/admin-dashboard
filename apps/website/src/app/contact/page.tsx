...
export default function ContactPage() {
    return (
        <main className="min-h-screen bg-white text-zinc-950 font-sans selection:bg-black selection:text-white pb-0 flex flex-col pt-32 md:pt-40">
            <div className="flex-1 container max-w-4xl mx-auto px-6 md:px-12 flex flex-col items-center justify-center mb-16 md:mb-24">
                <div className="text-center mb-10 w-full">
                    <h1 className="font-display text-4xl md:text-5xl lg:text-7xl font-bold tracking-tight text-zinc-900 mb-4 leading-tight">
                        Contact Us
                    </h1>
